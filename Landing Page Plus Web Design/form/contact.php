...
$address = "luiz_naiper@hotmail.com";
...
$e_subject = 'Correo de la nueva landing page ' . $name . '.';
...
$e_body = "Te contctó $name. Su mensaje es..." . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "Puedes contactarlo $name via email, $email";
